...
class ShowEventListTest extends AbstractWebUserControllerTest {
    ...
    void test_previousMonthIsSettled_completeResponseObject() throws Exception {
        ...
        this.monthlySettlementService.upsertMonthlySettlements(List.of(monthlySettlement));
    ...
    void test_importedImportedMoneyflow_isIgnored() throws Exception {
        ...
        Assertions.assertNotNull(actual.getNumberOfImportedMoneyflows());
        final int numberOfImportedMoneyflows = actual.getNumberOfImportedMoneyflows();
