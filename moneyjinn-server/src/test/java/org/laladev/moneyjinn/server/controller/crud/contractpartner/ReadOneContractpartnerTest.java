...
class ReadOneContractpartnerTest extends AbstractContractpartnerTest {
  ...
  void test_HappyCase_ResponseObject() throws Exception {
    final ContractpartnerTransport expected = new ContractpartnerTransportBuilder()
        .forContractpartner1().build();

    final ContractpartnerTransport actual = super.callUsecaseExpect200(
        ContractpartnerTransport.class, ContractpartnerTransportBuilder.CONTRACTPARTNER1_ID);
