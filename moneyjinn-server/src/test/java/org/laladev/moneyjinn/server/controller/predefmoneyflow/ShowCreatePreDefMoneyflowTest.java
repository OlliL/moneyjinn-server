...
public class ShowCreatePreDefMoneyflowTest extends AbstractControllerTest {
  ...
  public void test_completeResponseObject() throws Exception {
    final ShowCreatePreDefMoneyflowResponse expected = new ShowCreatePreDefMoneyflowResponse();
    ...
    final ShowCreatePreDefMoneyflowResponse actual = super.callUsecaseWithoutContent("",
        this.method, false, ShowCreatePreDefMoneyflowResponse.class);
