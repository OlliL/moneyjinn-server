...
public class ShowDeleteContractpartnerAccountTest extends AbstractControllerTest {
  ...
  public void test_ContractpartnerAccount1_completeResponseObject() throws Exception {
    ...
    final ShowDeleteContractpartnerAccountResponse actual = super.callUsecaseWithoutContent(
        ...
        false, ShowDeleteContractpartnerAccountResponse.class);
    Assertions.assertEquals(expected, actual);
  }

  @Test
  public void test_ContractpartnerAccount1AsDifferingUserSameGroup_completeResponseObject()
      throws Exception {
  ...
  @Test
  public void test_ContractpartnerAccount1AsDifferingUserOtherGroup_emptyResponseObject()
      throws Exception {
