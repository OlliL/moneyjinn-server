...
public class ShowAddMoneyflowsTest extends AbstractControllerTest {
  ...
  public void test_completeResponseObject() throws Exception {
    ...
    Assertions.assertEquals(expected.getCapitalsourceTransports(),
        actual.getCapitalsourceTransports());
    Assertions.assertEquals(expected.getContractpartnerTransports(),
        actual.getContractpartnerTransports());
    Assertions.assertEquals(expected.getPostingAccountTransports(),
        actual.getPostingAccountTransports());
    Assertions.assertEquals(expected.getPostingAccountTransports(),
        actual.getPostingAccountTransports());
