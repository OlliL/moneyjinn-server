...
class UpdateContractpartnerAccountTest extends AbstractContractpartnerAccountTest {
  ...
  private void testError(final ContractpartnerAccountTransport transport,
    ...
    final ValidationResponse actual = super.callUsecaseExpect422(transport,
  ...
  void test_standardRequest_RepresentationReturn() throws Exception {
    ...
    final ContractpartnerAccountTransport actualTransport = super.callUsecaseExpect200Representation(
        transport, ContractpartnerAccountTransport.class);
