...
public class HttpHeadersBuilder {
  ...
  protected HttpHeadersBuilder() {
    ...
    this.dateFormatter = DateTimeFormatter
        .ofPattern(RESTAuthorization.DATE_HEADER_FORMAT, Locale.US).withZone(ZoneId.of("GMT"));
    try {
  ...
  public HttpHeaders getAuthHeaders(final String userName, final String userPassword,
      final ZonedDateTime dateTime, final String uri, final String body,
    ...
    if (userName != null && userPassword != null) {
      ...
      final byte[] secret = BytesToHexConverter.convert(this.sha1Md.digest(userPassword.getBytes()))
          .getBytes();
      final String authString = this.restAuthorization.getRESTAuthorization(secret,
          httpMethod.toString(), contentType, uri,
          httpHeaders.getFirst(RESTAuthorization.DATE_HEADER_NAME), body.getBytes(), userName);
