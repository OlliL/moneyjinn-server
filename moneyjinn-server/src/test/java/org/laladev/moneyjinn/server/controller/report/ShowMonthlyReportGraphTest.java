...
public class ShowMonthlyReportGraphTest extends AbstractControllerTest {
  ...
  public void test_maxDateRange_response() throws Exception {
    ...
    final ShowMonthlyReportGraphResponse actual = super.callUsecaseExpect200(this.method, request,
  ...
  public void test_withUnselectedPostingAccountIDs_idsSaved() throws Exception {
    ...
    super.callUsecaseExpect200(this.method, request, ShowMonthlyReportGraphResponse.class);
  ...
  public void test_AuthorizationRequired_Error() throws Exception {
    ...
    super.callUsecaseExpect403(this.method, new ShowMonthlyReportGraphRequest());
  }
