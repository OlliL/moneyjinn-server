...
class UpsertMonthlySettlementTest extends AbstractControllerTest {
  ...
  @Test
   void test_regularMonthlySettlementInsert_SuccessfullNoContent() throws Exception {
    ...
    Assertions.assertEquals(monthlySettlementTransport.getYear(),
        monthlySettlements.iterator().next().getYear());
  ...
  @Test
   void test_regularMonthlySettlementUpdate_SuccessfullNoContent() throws Exception {
    ...
    Assertions.assertEquals(0, new MonthlySettlementTransportBuilder().forMonthlySettlement3()
        .build().getAmount().compareTo(monthlySettlements.get(2).getAmount()));
  }
