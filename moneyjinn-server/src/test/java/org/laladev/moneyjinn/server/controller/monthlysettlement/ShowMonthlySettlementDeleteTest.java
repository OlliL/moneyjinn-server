...
public class ShowMonthlySettlementDeleteTest extends AbstractControllerTest {
  ...
  public void test_unknownMonthlySettlement_emptyResponseObject() throws Exception {
    ...
    final ShowMonthlySettlementDeleteResponse actual = super.callUsecaseWithoutContent("/1970/10",
        this.method, false, ShowMonthlySettlementDeleteResponse.class);
  ...
  public void test_MonthlySettlement_completeResponseObject() throws Exception {
    ...
    final ShowMonthlySettlementDeleteResponse actual = super.callUsecaseWithoutContent("/2008/12",
        this.method, false, ShowMonthlySettlementDeleteResponse.class);
    Assertions.assertEquals(expected, actual);
  }

  @Test
  public void test_MonthlySettlement1AsDifferingUserOtherGroup_emptyResponseObject()
      throws Exception {
