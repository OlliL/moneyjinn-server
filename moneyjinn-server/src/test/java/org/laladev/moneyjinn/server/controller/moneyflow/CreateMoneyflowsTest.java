...
public class CreateMoneyflowsTest extends AbstractControllerTest {
  ...
  public void test_oneNewMoneyflowSaveAsPreDefMoneyflow_Saved() throws Exception {
    ...
    final PreDefMoneyflow preDefMoneyflow = this.preDefMoneyflowService.getPreDefMoneyflowById(
        userId, new PreDefMoneyflowID(PreDefMoneyflowTransportBuilder.NEXT_ID));
  ...
  public void test_preDefMoneyflowSelectedAndUpdated_UpdateDoneLastUsedDateSet() throws Exception {
    ...
    Assertions.assertEquals(preDefMoneyflow.getCapitalsource().getId().getId(),
        transport.getCapitalsourceid());
