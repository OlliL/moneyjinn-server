...
public class AccessFlattenedDataMapperTest {
  ...
  public void testAccessFlattenedDataToModel() {
    ...
    Assertions.assertEquals(Long.valueOf(3l), accessRelation.getParentAccessRelation()
        .getParentAccessRelation().getParentAccessRelation().getId().getId());
    Assertions.assertEquals(Long.valueOf(4l),
        accessRelation.getParentAccessRelation().getParentAccessRelation().getParentAccessRelation()
