...
public class CrudContractpartnerAccountController extends AbstractController
  ...
  @Override
  public ResponseEntity<List<ContractpartnerAccountTransport>> readAll(
    ...
    return ResponseEntity
        .ok(super.mapList(contractpartnerAccounts, ContractpartnerAccountTransport.class));
  }
  ...
  public ResponseEntity<ContractpartnerAccountTransport> create(
    ...
    return this.preferedReturn(prefer, contractpartnerAccount,
