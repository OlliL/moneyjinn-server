...
public class ShowMonthlySettlementListResponse extends AbstractResponse {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((this.numberOfAddableSettlements == null) ? 0
        : this.numberOfAddableSettlements.hashCode());
    result = prime * result + ((this.numberOfEditableSettlements == null) ? 0
        : this.numberOfEditableSettlements.hashCode());
