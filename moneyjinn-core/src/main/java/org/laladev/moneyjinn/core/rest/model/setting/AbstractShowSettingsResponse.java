...
public abstract class AbstractShowSettingsResponse extends AbstractResponse {
  ...
  public int hashCode() {
    ...
    result = prime * result
        + ((this.numFreeMoneyflows == null) ? 0 : this.numFreeMoneyflows.hashCode());
    return result;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    final AbstractShowSettingsResponse other = (AbstractShowSettingsResponse) obj;
  ...
  public String toString() {
    ...
    builder.append("AbstractShowSettingsResponse [language=");
    builder.append(this.language);
    builder.append(", dateFormat=");
    builder.append(this.dateFormat);
    builder.append(", maxRows=");
    builder.append(this.maxRows);
    builder.append(", numFreeMoneyflows=");
    builder.append(this.numFreeMoneyflows);
    builder.append("]");
