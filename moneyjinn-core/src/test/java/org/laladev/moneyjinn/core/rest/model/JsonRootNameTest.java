...
public class JsonRootNameTest {
  /**
   * This test makes sure all REST-Model classes which are annotated with {@link JsonRootName} have
   * JsonRootName matching to their class name. One exception is {@code ErrorResponse} which is
   * intended to be named "error" in the REST Response.<br>
   * <br>
