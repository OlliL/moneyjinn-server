...
public class RESTAuthorizationTest {
  ...
  public void testRESTAuthorization_emptyBody()
    ...
    final String key = this.restAuthorization.getRESTAuthorization(secret, httpVerb, contentType,
        url, date, body, ident);
    Assertions.assertEquals("MNFklaus:ODg0MjgwMTBiNzhlZTI1NmU4MGE0NWYxNmVlYjYyNTEwYTM3YzJiMA==",
        key);
  }
  ...
  public void testRESTAuthorization_withBody()
    ...
    final String key = this.restAuthorization.getRESTAuthorization(secret, httpVerb, contentType,
        url, date, body, ident);
    Assertions.assertEquals("MNFklaus:MjQ1NTZlNzJiOTg5MTg1ODhjNTc1MmEyMmFiNmIxNTU2MjFiNDdmMQ==",
        key);
  }
  ...
  public void testOptionalFieldsNull_noNPE()
    ...
    this.restAuthorization.getRESTAuthorization(secret, httpVerb, contentType, url, date, body,
        ident);
  }
}